<template>
  <div id="leaderboard">
    <div class="header">
      <img
        class="header__img"
        src="https://www.freeiconspng.com/thumbs/leaderboard-icon/leaderboard-icon-9.png"
      />
    ...
    <div class="sg">
      <table>
        <tr>
          <th>
            <img
              src="https://image.flaticon.com/icons/png/512/15/15643.png"
              class="rank_img"
            />
            Rank
          </th>
          ...
          <th>
            <img
              src="https://cdn4.iconfinder.com/data/icons/plastic-bag/100/plastic_bag-06-512.png"
              class="plastic_img"
            />
            Total Plastic Saved
          </th>
...
export default {
  ...
  methods: {
      ...
      database
        ...
        .then((snapshot) => {
          ...
          for (var index in this.friends_username) {
            ...
            database
              .collection("users")
              .where("username", "==", this.friends_username[index])
              .get()
              .then((querySnapshot) => {
        ...
        .then((snapshot) => {
          snapshot.docs.forEach((doc) => {
            ...
            this.sg.push({
              ...
              total_plastic: user.totalplastic,
            });
          });
        });
    },
    ...
    sortArrays: function(arrays) {
      return arrays
        .sort((a, b) => b.total_plastic - a.total_plastic)
        .slice(0, 10);
    },
  },
  created() {
