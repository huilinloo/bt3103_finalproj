...
<div id="app">
  <img src="https://i.postimg.cc/4xwY4sR5/wolrd-environmental-day-copy-2.jpg" align="left">
	...
	<div class="input_container">
        ...
        <input type="text" id="phone" class="form-control form-control-lg" v-model.lazy="phone" required>
        <p v-if="checkPhone() == true">{{"Username is " + this.username}}</p>
        <br><br>
        <label style = "font-size: 20px;" for="points">Points Earned: </label><br>
        ...
        <table id = "info">
          ...
          <tr>
            <td>Straw</td>
            <td>5</td>
            <td><input min = "0" type = "number" v-model.number.lazy = "straw_qty" style = "width: 50px;height = 20px" required></td>
          </tr>
          <tr>
            <td>Plastic Bag</td>
            <td>10</td>
            <td><input min = "0" type = "number" v-model.number.lazy = "pb_qty" style = "width: 50px" required></td>
          </tr>
          <tr>
            <td>Plastic Container</td>
            <td>20</td>
            <td><input min = "0" type = "number" v-model.number.lazy = "pc_qty" style = "width: 50px" required></td>
          </tr>
        </table>
        <br>
        ...
        addPoints: function() {
            if (this.sameNumber == false) {
                ...
                if (this.date in this.list_plastic) {
                  this.list_plastic[this.date] = this.list_plastic[this.date] + this.new_points
                } 
                ...
                this.plastic_cat['straw'] = this.plastic_cat['straw'] + this.straw_qty * 5
                this.plastic_cat['plastic_bag'] = this.plastic_cat['plastic_bag'] + this.pb_qty * 10 
                this.plastic_cat['plastic_container'] = this.plastic_cat['plastic_container'] + this.pc_qty * 20
